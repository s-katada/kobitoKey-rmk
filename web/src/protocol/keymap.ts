 ...
 * flat buffer. For kobitokey (4 × 4 × 10 × 2) that's 320 bytes — fetched
 ...
 * combos, AND BLE bond information. On kobitokey this drops every paired
...
/**
 * Vial-compat no-op on kobitokey. RMK persists each `CustomSetValue` on
