 ...
 * authoritative reference for kobitokey's firmware — every encoding range
 ...
 *   0x7E00..0x7E0F  User N (= kobitokey customKeycodes via vial.json)
 *
...
/**
 * User catalogue. User0..User7 are kobitokey-defined customKeycodes and pick
...
export interface LabelOptions {
  /** kobitokey customKeycodes used to humanise User0..User7. */
