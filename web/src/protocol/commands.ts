 ...
 * `WebHidTransport.sendAndReceive` to actually talk to kobitokey.
 */
 ...
 * list of physical keys configured as the unlock chord (kobitokey's
 ...
 * information. Use with care: on kobitokey this also drops the BLE
 ...
 * write so this is a no-op on kobitokey, but vial-gui issues it after
 * lighting tweaks and we keep parity for compatibility with any
 * tooling that piggy-backs on the kobitokey-editor transport.
 */
 ...
 *   reply[1] = combo entries      (`COMBO_MAX_NUM`; kobitokey = 16)
