 ...
 *
 * Shows the latest GitHub release of kobitokey firmware (`firmware-latest`
  ...
  return (
    <section className="space-y-4">
      ...
      <p className="text-sm text-zinc-600 dark:text-zinc-400">
        GitHub Actions が自動ビルドした kobitokey の最新ファームウェアです。central / peripheral の XIAO
      ...
      {state.kind === 'ready' && state.releases.length === 0 && (
        <div className="rounded-md border border-amber-300 dark:border-amber-700 bg-amber-50 dark:bg-amber-950/40 p-3 text-sm">
          ...
          <a
            ...
            href="https://github.com/s-katada/kobitokey-rmk/actions/workflows/firmware.yml"
            target="_blank"
            rel="noreferrer"
          >
            Firmware ワークフロー
