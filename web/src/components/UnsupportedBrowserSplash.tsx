/**
 * Full-page splash shown when the current browser cannot run kobitokey-editor.
 *
      ...
      >
        ...
        <section className="space-y-3 text-sm">
          ...
          <details className="rounded-md bg-zinc-50 dark:bg-zinc-900 px-3 py-2">
            ...
            <p className="mt-2 text-xs text-zinc-600 dark:text-zinc-300 leading-relaxed">
              kobitokey-editor はキーボードに直接 USB / BLE 経由でキーマップを書き込みます。これには
        ...
        {reason === 'ios' && (
          <p className="text-xs text-zinc-500 dark:text-zinc-400 italic">
            ...
            インストールしても WebHID は使えません。kobitokey
...
const COPY: Record<UnsupportedReason, { title: string; body: string }> = {
  ios: {
    title: 'iOS では kobitokey-editor を実行できません',
