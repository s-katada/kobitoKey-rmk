  ...
  return [
    {
      ...
      html_url: 'https://github.com/s-katada/kobitokey/releases/tag/firmware-latest',
      ...
      assets: [
        {
          ...
          browser_download_url:
            'https://github.com/s-katada/kobitokey/releases/download/firmware-latest/central.uf2',
        },
        {
          name: 'peripheral.uf2',
          size: 581632,
          browser_download_url:
            'https://github.com/s-katada/kobitokey/releases/download/firmware-latest/peripheral.uf2',
        },
      ],
    },
  ];
