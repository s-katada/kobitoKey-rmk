...
const kobitokeyLayout: KeyboardLayoutDef = {
...
describe('buildCells', () => {
  it('emits one cell per "r,c" entry, respecting `{x: N}` skips', () => {
    const layout = kobitokeyLayout.layouts.keymap as ReadonlyArray<ReadonlyArray<LayoutEntry>>;
...
describe('KeymapView', () => {
  ...
  it('renders the kobitokey customKeycode label for User0', () => {
