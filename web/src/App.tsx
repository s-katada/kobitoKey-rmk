...
export default function App() {
  ...
  // talk to kobitokey. The splash explains what to do; rendering the
    ...
    <div className="min-h-full bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100">
      <header className="border-b border-zinc-200 dark:border-zinc-800 px-6 py-4">
        <div className="flex items-baseline justify-between gap-4">
          <div>
            <h1 className="text-xl font-semibold tracking-tight">kobitokey-editor</h1>
            <p className="text-sm text-zinc-500 dark:text-zinc-400">
              kobitokey スプリットキーボード向けの Web キーマップエディタ
            </p>
          </div>
          <ConnectionStatus />
        </div>
