/**
 * Hook + types for fetching kobitokey firmware releases from GitHub.
 *
 * Reads `https://api.github.com/repos/s-katada/kobitokey-rmk/releases` (public,
...
const GITHUB_REPO = 'kobitokey-rmk';
