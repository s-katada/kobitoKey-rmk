/**
 * Transport-layer constants for talking to kobitokey over the Vial wire
...
/** USB vendor id from `../keyboard.toml`. */
export const KOBITOKEY_VENDOR_ID = 0x4b4b;

/** USB product id from `../keyboard.toml`. */
export const KOBITOKEY_PRODUCT_ID = 0x0001;
