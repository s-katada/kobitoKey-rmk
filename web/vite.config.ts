...
export default defineConfig({
  plugins: [
    react(),
    tailwindcss(),
    // kobitokey-editor is a pure client-side app — all real work happens
    ...
    VitePWA({
      ...
      manifest: {
        name: 'kobitokey-editor',
        short_name: 'kobitokey-editor',
        description: 'Web keymap editor for the kobitokey split keyboard. Works offline once installed.',
        theme_color: '#863bff',
