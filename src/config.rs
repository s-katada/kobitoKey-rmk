...
impl Default for KobitokeySettings {
...
// ─── Singletons ─────────────────────────────────────────────────────
//
// One atomic per field. Initial values match `KobitokeySettings::default()`
...
#[allow(dead_code)]
pub fn apply(settings: KobitokeySettings) {
...
#[allow(dead_code)]
pub fn snapshot() -> KobitokeySettings {
    KobitokeySettings {
